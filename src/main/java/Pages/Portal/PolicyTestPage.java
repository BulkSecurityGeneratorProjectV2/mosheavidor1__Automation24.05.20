...
//        typeIp.element.sendKeys("100.20.3.71");
    ...
    //Click on security  popup message:


    public static final By PolicyTestClickOnPop = By.xpath("/html/body/div/div[1]/div/div/twa-button[1]/material-button");


    @FindBy(how = How.XPATH, using = "/html/body/div/div[1]/div/div/twa-button[1]/material-button")

    private WebElement Popup_click;

    public void ClickOnPoP() {


        Button click_POP = new Button(Popup_click);

        click_POP.element.click();
